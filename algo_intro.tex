...
Dieser Ansatz ist allerdings nur bei sehr kleinen zyklischen Gruppen zielführend, da die Laufzeit direkt von der Ordnung der Gruppe bestimmt wird. Für eine gegeben Gruppe $\mathbb{G}$ ergibt sich also ein Laufzeit in $\mathcal{O}(ord(\mathbb{G}))$.
