...
Weiterhin ist anzumerken, dass das ElGamal"=Verfahren eng mit dem Diffie"=Hellman"=Schema verwandt ist. Dies ist kein Zufall, den Taher El Gamal erkannte 1985, dass das Diffie"=Hellman Schlüsselaustauschverfahren zu einem Public"=Key Verschlüsselungsverfahren erweitert werden kann.
...
Das National Institute of Standards and Technology (oder kurz NIST) hat eine Auswahl an empfohlenen Parametern veröffentlicht.
...
Das Verfahren hat allerdings auch Nachteile, wie beispielsweise der Nachrichtenraum, welcher durch die gewählt Gruppe $\mathbb{G}$ bestimmt wird. Für manche Gruppen ist es jedoch möglich eine umkehrbare Kodierung von Gruppenelementen zu Bitstrings zu definieren und dieses Problem damit zu umgehen.
\reference{\hyperref[ref_1]{1}, S. 404}
